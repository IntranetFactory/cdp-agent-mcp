> **Note:** This is the original README from [chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp). For documentation specific to cdp-agent-mcp, see [README.md](./README.md).
